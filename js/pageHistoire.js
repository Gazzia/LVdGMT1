function refHistoire() {
  ...
  if (région == "Pouce") {
    if (milieu == "Merryvale"){
      if (zone == "Egouts"){
        $("#histoireTitle").html("Dans les égouts");
        $("#histoire").html("Vous marchez quelques mètres sous la terre et débouchez dans un conduit humide, dans le noir. Devant vous, une échelle de bois mène à une trappe, qui vous mènera à la surface. Mais sur votre gauche, quelque chose luit dans le noir, voulez-vous vous approcher ?");
      }
      if (zone == 4) {
